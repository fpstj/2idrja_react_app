...
const OurMisiion = () => {
  return (
    <>
      ...
      <div className="d-flex flex-column my-5 frame w-100">
        <div className="d-flex flex-row w-100">
          ...
          <div className="d-flex flex-column col-6 w-100">
            <div className="d-flex flex-column col-6 p-3 pe-5 paragraph lh-lg">
              ...
              endeavor to spearhead transformative changes in various fields.Our dedicated team is
              at the forefront of scientific exploration, working tirelessly to unlock new
              solutions, technologies, and methodologies that have the potential to reshape
              industries and improve the overall human experience.Join us in our relentless pursuit
              of knowledge, as we strive to create a world where innovation thrives and
              groundbreaking research propels us towards a brighter
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="d-flex flex-column col-6 w-100">
            <div className="d-flex flex-column col-6 p-3 pe-5 paragraph lh-lg">
              <p className="ps-4 paragraph lh-lg pt-4">
                ...
                commitment to excellence, collaboration, and societal benefit, our mission is to be
                a catalyst for positive impact. We aspire to lead the way in pioneering
                breakthroughs, fostering a culture of curiosity, and driving meaningful advancements
                that resonate globally. Join us on this journey as we strive to make an indelible
                mark on the world, driven by a mission that transcends boundaries and inspires a
